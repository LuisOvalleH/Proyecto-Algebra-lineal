...
class Matrix_determinat_window(QWidget):
    ...
    def __init__(self):
        ...
        title_label = QLabel("Determinante de una matriz")
    ...
    def calculate_reverse(self):
        ...
        self.result = matrix.determinant()
        self.matrix_result = matrix.matrix_gauss
...
if __name__ == "__main__":
    ...
    window = Matrix_determinat_window()
    window.show()
    sys.exit(app.exec())